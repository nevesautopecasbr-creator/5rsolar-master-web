/**
 * Ícones solares consistentes - 5R Energia Solar
 * Elementos que remetem a raios, energia e renovação
 */

export function IconSolarRays({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconSunEnergy({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
